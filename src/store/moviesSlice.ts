...
import { Movie, MovieDbState } from '../types/movieModels';
...
type MoviesState = {
  ...
  transformations: FetchMoviesParams,
};
...
export const fetchMovies = createAsyncThunk<MoviesState, FetchMoviesParams, { state: RootState }>(
  'fetchMovies',
  async (config: FetchMoviesParams, { getState }) => {
    getState()
